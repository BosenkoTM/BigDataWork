...
# Задание 1. Комплексный анализ больших экономических данных с использованием технологий Hadoop и Spark

## Цель задания
Освоить методы обработки и анализа больших объемов экономических данных с использованием распределенной файловой системы Hadoop HDFS и инструментов Apache Spark (PySpark/PySpark SQL). Разработать навыки извлечения, трансформации и анализа данных для выявления экономических закономерностей и представления результатов в виде аналитических отчетов.
...
**Исходные данные:**
Большие датасеты в форматах CSV/JSON, требующие распределенной обработки из-за объема, превышающего возможности локальной машины.
